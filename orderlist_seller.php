...
// Mock data for orders (replace with real database query)
$orders = [
...
<head>
    ...
    <title>Order List - Seller Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="orderlist_seller.php" class="nav-link" class="active">Order List</a>
